    ...
    <ul>
        <?php foreach ($main_categories as $main_category) { ?>
            <li>
                ...
                <div id="descrMainBlock_<?=$main_category['id']?>" class="hidden"><?= $main_category['description'] ?></div>
                ...
                <ul>
                    ...
                    <li class="secondList hidden" data-target="second_<?=$main_category['id']?>">
                        <div class="listItem">
                        ...
                        <div id="descrSecondBlock_<?=$item['id']?>" class="hidden"><?= $item['description'] ?></div>
                        ...
                        <ul>
                            ...
                            <li class="goodList hidden" data-target="good_<?=$item['id']?>">
                                <div class="">
                                    <p class="goodName" data-id="<?=$good['id']?>" ><?php echo $good['name'];?></p>

                                    <div id="descrGoodBlock_<?=$good['id']?>" class="hidden"><?= $good['description'] ?></div>
